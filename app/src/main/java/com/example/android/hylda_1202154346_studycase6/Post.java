...
public class Post extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nDatabaseRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Database crnt = dataSnapshot.getValue(Database.class);
    ...
    public void btnKomen(View view) {
        ...
        pd.show();
        //inisialisasi objek
        Database cmnt = new Database(nUsr, comments.getText().toString(), imageid);
        ...
        nDatabaseRef.push().setValue(cmnt).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    //memunculkan toast
                    Toast.makeText(Post.this, "You commented on this post", Toast.LENGTH_SHORT).show();

                    //set field menjadi kosong kemali
                    comments.setText(null);
                } else {
                    //apabila tidak berhasil maka muncul toas berisi gagal menambah komen
                    Toast.makeText(Post.this, "Failed to add comment", Toast.LENGTH_SHORT).show();
                }
                //menutup dialog
                pd.dismiss();
            }
